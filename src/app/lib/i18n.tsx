...
export const chromeCopy = {
  'de-CH': {
    ...
    settings: {
      ...
      notificationsCard: 'E-Mail-Benachrichtigungen',
      notificationsHint: 'FinPlan erinnert dich per E-Mail an wichtige Fristen und Chancen in deiner Finanzplanung.',
      notificationsEnabled: 'E-Mail-Benachrichtigungen aktivieren',
      reminderAnnualReview: 'Jährliche Überprüfungserinnerung',
      reminderAnnualReviewHint: 'Erinnerung im Januar, deinen Finanzplan zu aktualisieren.',
      reminderSaule3a: 'Säule-3a-Jahresendfrist',
      reminderSaule3aHint: 'Erinnerung im November, den Maximalbeitrag vor dem 31. Dezember einzuzahlen.',
      reminderQuarterly: 'Quartalsübersicht',
      reminderQuarterlyHint: 'Leichte Erinnerung zu jedem Quartalsbeginn, die Planung kurz zu überprüfen.',
      reminderPkEinkauf: 'Pensionskassen-Einkauf',
      reminderPkEinkaufHint: 'Erinnerung, wenn du dich ca. 10 Jahre vor deinem Zielrentenalter befindest.',
  ...
  en: {
    ...
    settings: {
      ...
      notificationsCard: 'Email Notifications',
      notificationsHint: 'FinPlan sends you email reminders for important deadlines and opportunities in your financial plan.',
      notificationsEnabled: 'Enable email notifications',
      reminderAnnualReview: 'Annual review reminder',
      reminderAnnualReviewHint: 'Reminder in January to update your financial plan.',
      reminderSaule3a: 'Pillar 3a year-end deadline',
      reminderSaule3aHint: 'Reminder in November to make your maximum contribution before December 31.',
      reminderQuarterly: 'Quarterly check-in',
      reminderQuarterlyHint: 'Light reminder at the start of each quarter to review your plan.',
      reminderPkEinkauf: 'Pension fund top-up',
      reminderPkEinkaufHint: 'Reminder when you are approx. 10 years from your target retirement age.',
  ...
  'fr-CH': {
    ...
    settings: {
      ...
      notificationsCard: 'Notifications par e-mail',
      notificationsHint: 'FinPlan vous envoie des rappels par e-mail pour les échéances et opportunités importantes de votre planification financière.',
      notificationsEnabled: 'Activer les notifications par e-mail',
      reminderAnnualReview: 'Rappel de révision annuelle',
      reminderAnnualReviewHint: 'Rappel en janvier pour mettre à jour votre plan financier.',
      reminderSaule3a: 'Échéance annuelle pilier 3a',
      reminderSaule3aHint: 'Rappel en novembre pour verser la cotisation maximale avant le 31 décembre.',
      reminderQuarterly: 'Bilan trimestriel',
      reminderQuarterlyHint: 'Léger rappel au début de chaque trimestre pour revoir brièvement votre plan.',
      reminderPkEinkauf: 'Rachat de caisse de pension',
      reminderPkEinkaufHint: "Rappel lorsque vous êtes à environ 10 ans de votre âge de retraite cible.",
      saveNotifications: 'Enregistrer les paramètres',
  ...
  'it-CH': {
    ...
    settings: {
      ...
      notificationsCard: 'Notifiche via e-mail',
      notificationsHint: 'FinPlan ti invia promemoria via e-mail per scadenze e opportunità importanti nella tua pianificazione finanziaria.',
      notificationsEnabled: 'Attiva notifiche via e-mail',
      reminderAnnualReview: 'Promemoria revisione annuale',
      reminderAnnualReviewHint: 'Promemoria a gennaio per aggiornare il tuo piano finanziario.',
      reminderSaule3a: 'Scadenza annuale pilastro 3a',
      reminderSaule3aHint: 'Promemoria a novembre per versare il contributo massimo entro il 31 dicembre.',
      reminderQuarterly: 'Revisione trimestrale',
      reminderQuarterlyHint: 'Leggero promemoria a inizio trimestre per rivedere brevemente il piano.',
      reminderPkEinkauf: 'Riscatto cassa pensioni',
      reminderPkEinkaufHint: "Promemoria quando mancano circa 10 anni all'età di pensionamento prevista.",
      saveNotifications: 'Salva impostazioni',
